...
public class NotificationUtils {
    ...
    // Unique integer ID for the pending intent
    private static final int PENDING_INTENT_ID = 21;
    // Notification channel id
    private static final String WATER_REMINDER_NOTIFICATION_CHANNEL_ID = "reminder_notification_channel";
    // Notification ID
    private static final int WATER_REMINDER_NOTIFICATION_ID = 3121;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        notificationManager.notify(WATER_REMINDER_NOTIFICATION_ID,
                mBuilder.build());
    }
